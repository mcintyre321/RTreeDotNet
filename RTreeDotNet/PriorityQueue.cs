 ...
 */
    ...
    {
        //implements Serializable { private const   
        //long serialVersionUID = -5653506138757217673L;
        public const
        ...
        public PriorityQueue(bool sortOrder)
         :   this(sortOrder, 10)
        { 
        }

        public PriorityQueue(bool sortOrder, int initialCapacity)
        {
   ...
   */
        ...
        private void promote(int index, int value, float priority)
        {
            ...
            // constly, copy the value/priority into the hole.
            while (index > 0)
            {
        ...
        private void check()
        {
            ...
            for (int i = 0; i < values.Count/2; i++)
            {
                ...
                if (leftIndex <= lastIndex)
                {
                    ...
                    {
                        throw new Exception("Internal error in PriorityQueue");
                    }
                }
