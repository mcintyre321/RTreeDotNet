 ...
 */
   ...
   */
        ...
        static public bool intersects(float r1MinX, float r1MinY, float r1MaxX, float r1MaxY,
   ...
   */
        ...
        static public bool contains(float r1MinX, float r1MinY, float r1MaxX, float r1MaxY,
            float r2MinX, float r2MinY, float r2MaxX, float r2MaxY)
        {
   ...
   */
    ...
    */
            ...
            float r2MinX, float r2MinY, float r2MaxX, float r2MaxY)
        {
            ...
            if (float.IsPositiveInfinity(r1Area))
            {
            ...
            if (float.IsPositiveInfinity(r1r2UnionArea))
            {
