 ...
 */
    ...
    public class Node
    {
       ...
       internal float mbrMinX = float.MaxValue;
       internal float mbrMinY = float.MaxValue;
       internal float mbrMaxX = -float.MaxValue;
        internal float mbrMaxY = -float.MaxValue;

        internal float[] entriesMinX = null;
        internal float[] entriesMinY = null;
        internal float[] entriesMaxX = null;
        internal float[] entriesMaxY = null;
        ...
        internal void AddEntry(float minX, float minY, float maxX, float maxY, int id)
        {
            ids[entryCount] = id;
        ...
        internal int findEntry(float minX, float minY, float maxX, float maxY, int id)
        {
        ...
        internal void deleteEntry(int i)
        {
        ...
        internal void recalculateMBRIfInfluencedBy(float deletedMinX, float deletedMinY, float deletedMaxX, float deletedMaxY)
        {
   ...
   */
        ...
        internal void reorganize(RTree rtree)
        {
