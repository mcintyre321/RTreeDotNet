 ...
 */
   ...
   */
        IEnumerable<T> Nearest(Point p, float furthestDistance);
   ...
   * no matter how far away, although this will slow down the algorithm.
   */
        IEnumerable<T> NearestN(Point p, int n, float distance);
   ...
   */
        IEnumerable<T> NearestNUnsorted(Point p, int n, float distance);
        ...
        /**
           ...
           */
        IEnumerable<T> Intersects(Rectangle r);
        ...
        /**
           ...
           */
        IEnumerable<T> Contains(Rectangle r);
